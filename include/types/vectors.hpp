...
inline Vector2 operator-(Vector2 lhs, const Vector2 &rhs) { lhs -= rhs; return lhs; }
inline Vector2 operator*(Vector2 lhs, float scalar) { lhs *= scalar; return lhs; }
inline Vector2 operator*(float scalar, Vector2 rhs) { rhs *= scalar; return rhs; }
inline Vector2 operator/(Vector2 lhs, float scalar) { lhs /= scalar; return lhs; }
...
inline Vector3 operator-(Vector3 lhs, const Vector3 &rhs) { lhs -= rhs; return lhs; }
inline Vector3 operator*(Vector3 lhs, float scalar) { lhs *= scalar; return lhs; }
inline Vector3 operator*(float scalar, Vector3 rhs) { rhs *= scalar; return rhs; }
inline Vector3 operator/(Vector3 lhs, float scalar) { lhs /= scalar; return lhs; }
...
inline Vector4 operator-(Vector4 lhs, const Vector4 &rhs) { lhs -= rhs; return lhs; }
inline Vector4 operator*(Vector4 lhs, float scalar) { lhs *= scalar; return lhs; }
inline Vector4 operator*(float scalar, Vector4 rhs) { rhs *= scalar; return rhs; }
inline Vector4 operator/(Vector4 lhs, float scalar) { lhs /= scalar; return lhs; }
